...
<header id="header" style="top:0;" aria-label='Header'>
    ...
    <nav aria-label="Main" id="topNav">
        <ul>
            ...
            <?php if($page !== 'Login'):?>
            <li>
                <a class="menuIt" aria-label="<?php if(isset($_SESSION['uname'])){echo 'Profile';}else{echo 'Log in';}?>" href="<?php if(isset($_SESSION['uname'])){echo './functions/profile.php';}else{echo 'login.php';}?>">
                    <div id="log" class="menuTtl"><?php if(isset($_SESSION['uname'])){echo 'Profile';}else{echo 'Log in';}?></div>
                    <svg role="img" overflow="visible" aria-label="<?php if(isset($_SESSION['uname'])){echo 'Profile';}else{echo 'Log in';}?>" width="30" height="30" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            stroke-width="1.5"
