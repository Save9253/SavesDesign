        ...
        <ul>
            ...
            <li>
                <a class="menuIt" aria-label="<?php if(isset($_SESSION['uname'])){echo 'Log out';}else{echo 'Log in';}?>" href="<?php if(isset($_SESSION['uname'])){echo 'functions/logout.php';}else{echo 'login.php';}?>">
                    ...
                    <svg role="img" overflow="visible" aria-label="<?php if(isset($_SESSION['uname'])){echo 'Log out';}else{echo 'Log in';}?>" width="30" height="30" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            stroke-width="1.5"
